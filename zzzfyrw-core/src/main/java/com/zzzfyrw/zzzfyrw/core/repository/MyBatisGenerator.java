package com.zzzfyrw.zzzfyrw.core.repository;
...
public class MyBatisGenerator{
    ...
    public static void main(String[] args) {
        ...
        config.setOutputDir(System.getProperty("user.dir")
                + File.separator+"zzzfyrw-core"+File.separator+"src"
        ...
        packageConfig.setParent("com.zzzfyrw.core");
        ...
        strategy.setInclude("sys_dict");//表名
